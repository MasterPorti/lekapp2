  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.message === "EMAIL_NOT_VERIFIED") {
        ...
        setSuccess("Tu cuenta no está verificada. Se envió un código a tu correo.");
        setError("");
      } else {
  ...
  return (
    ...
    >
      ...
      {verificationEmail ? (
        ...
        /* LOGIN CARD */
        <div className="max-w-md w-full bg-white border-4 border-gray-900 shadow-[8px_8px_0px_rgba(0,0,0,1)] p-6 sm:p-8 rounded-none">
          <h2 className="text-2xl font-bold font-display uppercase tracking-wide mb-6">Iniciar Sesión</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot-password" className="text-[10px] font-bold text-[#dc2a36] hover:underline">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 text-center">
            <p className="text-xs text-gray-600">
              ...
              <Link href="/register" className="font-bold text-[#dc2a36] hover:underline">
                Regístrate aquí
              </Link>
            </p>
          </div>
